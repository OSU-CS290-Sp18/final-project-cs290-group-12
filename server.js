...
app.get('/terms.html', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/terms.html'));
});
...
app.get('/stats', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/stats.html'));
});

app.get('/style.css', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/css/style.css'));
});

app.get('/chat_style.css', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/css/chat_style.css'));
});

app.get('/index.js', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/js/index.js'));
});

app.get('/chat.js', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/js/chat.js'));
});

app.get('/images/logo_white.png', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/images/logo_white.png'));
});

app.get('/images/logo.png', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/images/logo.png'));
});

app.get('/images/404_image.png', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/images/404_image.png'));
});
...
app.get('*', function(req, res) {
	res.sendFile(path.join(__dirname + '/public_html/404.html'));
});
